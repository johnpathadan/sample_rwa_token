...
async function uploadSecrets() {
  ...
  //this encryptedSecrets is what we are uploading to the DON

  //what secret slot that you want to use
  const slotIdNumber = 0;

  const expirationTimeMinutes = 1440; // 1 day - to reauthenticate and
  // update secrets after this time
